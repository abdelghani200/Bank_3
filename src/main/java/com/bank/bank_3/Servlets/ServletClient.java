...
public class ServletClient extends HttpServlet {
    ...
    public ServletClient() throws SQLException {
    ...
    private void listClients(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Optional<List<Client>> optionalClients = serviceClient.getAllClients();
        if (optionalClients.isPresent()) {
            List<Client> clients = optionalClients.get();
            request.setAttribute("clients", clients);
        } else {
            System.out.println("hdgd dgdh");
        }
